...
namespace Uno
{
  internal class GameData
  {
    ...
    public static frmUno form = (frmUno) null;
    ...
    public static void InitData(frmUno frm)
    {
      ...
      GameData.form = frm;
      GameData.readConfig();
      Logger.Write(3, string.Concat(new object[4]
      {
        (object) "form = ",
        (object) GameData.form,
        (object) " ; NULL? ",
        GameData.form == null ? (object) "yes" : (object) "no"
      }));
      GameData.buildImageList();
      GameData.backFacingCard = new Card(UnoCards.Back, 0, UnoColours.NoColor);
      Logger.FuncInit("GameData.InitData");
    }
